...
# [ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/pocketfulofrage/dotfiles.git"
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/lukesmithxyz/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/pocketfulofrage/larbs/master/progs.csv"
